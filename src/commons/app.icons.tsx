...
import {
  ...
  Cake,
  Calendar,
  CalendarOff, DeviceFloppy, FileExport, FileImport,
  Heartbeat,
  Home,
  InfoCircle,
  Pencil,
...
export const icons: Record<AppIcon, ReactNode> = {
  ...
  "headerHome": <Home size={16}/>,
  "headerSettings": <Settings size={16}/>,
  "headerSave": <DeviceFloppy size={16}/>,
  "menuFileImport": <FileImport size={14}/>,
  "menuFileExport": <FileExport size={14}/>,
